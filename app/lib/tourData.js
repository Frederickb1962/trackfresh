...
export const TOUR_SLIDES = [
  ...
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"Snap a receipt.", titleEs:"Fotografía tu recibo.", bodyEn:"Number one recommended way to start with TrackFresh. Every item, every field, autofilled, done in seconds.", bodyEs:"La forma número uno recomendada para empezar con TrackFresh. Cada artículo, cada campo, llenado solo, listo en segundos.", visual:{type:"img",src:"/tour-receipt.png"} },
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"Snap with Camera.", titleEs:"Escanear con Cámara.", bodyEn:"Snap one or up to six items — barcodes or labels, all in one shot.", bodyEs:"Escanea uno o hasta seis artículos — códigos de barras o etiquetas, todo en un solo disparo.", visual:{type:"img",src:"/tour-groceries.jpeg"} },
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"Just save the date.", titleEs:"Solo guarda la fecha.", bodyEn:"Voice recognition for expiration dates is available for hands free input.", bodyEs:"El reconocimiento de voz para fechas de vencimiento está disponible para entrada manos libres.", visual:{type:"emoji",value:"🎤"} },
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"Auto Detect.", titleEs:"Detección Automática.", bodyEn:"Food, category, shelf life, and expiration dates for after opening.", bodyEs:"Alimento, categoría, vida útil y fechas de vencimiento tras abrir.", visual:{type:"emoji",value:"🏷️"} },
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"Your fridge, freezer, and pantry.", titleEs:"Tu nevera, congelador y despensa.", bodyEn:"Organize Tracked Items lists everything by location. Each row shows EXP, category, storage tip, and name — tap ▼ to expand. Blinking red STATUS means add a date or use soon.", bodyEs:"Organiza tus artículos por ubicación. Cada fila muestra EXP, categoría, consejo de almacenamiento y nombre — toca ▼ para expandir. STATUS rojo parpadeante significa agregar fecha o usar pronto.", visual:{type:"emoji",value:"📦"} },
  { window:{ icon:"🥦", en:"Tracker", es:"Rastreador" }, titleEn:"One-week heads up.", titleEs:"Aviso con una semana de anticipación.", bodyEn:"We remind you before anything expires giving you advanced notice for preparation and to avoid food waste.", bodyEs:"Te avisamos antes de que algo venza para que puedas prepararte y evitar el desperdicio de alimentos.", visual:{type:"emoji",value:"⏰"} },
  { window:{ icon:"🍳", en:"Recipes", es:"Recetas" }, titleEn:"Cook what you've got.", titleEs:"Cocina lo que tienes.", bodyEn:"Get instant recipe ideas from ingredients that you have on hand in your fridge, freezer, or pantry.", bodyEs:"Obtén ideas de recetas al instante con los ingredientes que tienes a mano en tu nevera, congelador o despensa.", visual:{type:"emoji",value:"🍳"} },
  { window:{ icon:"🍳", en:"Recipes", es:"Recetas" }, titleEn:"Save what you love.", titleEs:"Guarda lo que te encanta.", bodyEn:"Tap the heart on any AI recipe that you have truly enjoyed to save it for later.", bodyEs:"Toca el corazón en cualquier receta de IA que hayas disfrutado de verdad para guardarla.", visual:{type:"emoji",value:"❤️"} },
  { window:{ icon:"🛒", en:"Shopping", es:"Lista de Compras" }, titleEn:"Your list, always ready.", titleEs:"Tu lista, siempre lista.", bodyEn:"Items auto-load as you use them. Add anything else with our AI-powered food list.", bodyEs:"Los artículos se cargan solos al usarlos. Agrega lo que falte con nuestra lista de alimentos con IA.", visual:{type:"emoji",value:"🛒"} },
  { window:{ icon:"🏪", en:"Stores", es:"Tiendas" }, titleEn:"Link and Shop.", titleEs:"Conecta y Compra.", bodyEn:"Link your favorite grocery stores. Shop smarter, save more.", bodyEs:"Conecta tus tiendas favoritas. Compra más inteligente, ahorra más.", visual:{type:"emoji",value:"🏪"} },
  { window:{ icon:"💰", en:"Search & Save", es:"Buscar y Ahorrar" }, titleEn:"Search and Save.", titleEs:"Buscar y Ahorrar.", bodyEn:"Find items near their expiry date and save up to 20% at checkout with participating stores — everyone wins and less food goes to waste.", bodyEs:"Encuentra artículos próximos a vencer y ahorra hasta 20% en caja en tiendas participantes — todos ganan y se desperdicia menos comida.", visual:{type:"emoji",value:"💰"} },
  { window:{ icon:"📅", en:"Meals", es:"Comidas" }, titleEn:"Plan your week.", titleEs:"Planifica tu semana.", bodyEn:"A practical way to add meals for every day with the ingredients you have.", bodyEs:"Una forma práctica de agregar comidas para cada día con los ingredientes que tienes.", visual:{type:"emoji",value:"📅"} },
  { window:{ icon:"🚨", en:"FDA Recalls", es:"Retiros FDA" }, titleEn:"Stay safe.", titleEs:"Mantente seguro.", bodyEn:"Real-time FDA recall alerts, right in the app.", bodyEs:"Alertas de retiros de la FDA en tiempo real, dentro de la app.", visual:{type:"emoji",value:"🚨"} },
  { window:{ icon:"🌐", en:"Language", es:"Idioma" }, titleEn:"English. Español.", titleEs:"Inglés. Español.", bodyEn:"Tap the flag — switch anytime.", bodyEs:"Toca la bandera — cambia cuando quieras.", visual:{type:"emoji",value:"🌐"} },
  { window:{ icon:"💬", en:"Suggestions", es:"Sugerencias" }, titleEn:"Your voice shapes TrackFresh.", titleEs:"Tu opinión forma TrackFresh.", bodyEn:"Tell us what to build next.", bodyEs:"Dinos qué construir después.", visual:{type:"img",src:"/tour-feedback.jpg"} },
