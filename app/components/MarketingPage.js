    ...
    <div className="mkt-page">
      ...
      <div className="mkt-section-wrap">
        ...
        <ul style={{listStyle:"none",padding:0,margin:"0 0 1rem",display:"flex",flexDirection:"column",gap:"0.6rem"}}>
          ...
          <li style={{display:"flex",alignItems:"flex-start",gap:"0.5rem",fontSize:"0.97rem"}}><span>⚠️</span><span><strong>{isEs ? "Alertas diarias de retiros de la FDA + Buscar y Ahorrar hasta 20% con supermercados asociados." : "Daily FDA recall alerts + Search & Save up to 20% with partner grocers."}</strong></span></li>
        </ul>
        </section>
