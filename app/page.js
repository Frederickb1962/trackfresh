...
const GLOBAL_STYLES = `
  ...
  .glass-scan-btn-apricot { background: rgba(251,160,90,0.28) !important; border-color: rgba(251,160,90,0.55) !important; }
  .glass-scan-btn-apricot:hover { background: rgba(251,160,90,0.42) !important; }
  .glass-scan-btn-apricot:active { background: rgba(251,160,90,0.18) !important; }
...
function AiBadge({ style = {} }) {
  return (
    <span style={{whiteSpace:"nowrap",...style}}>
      <span style={{color:"#f97316",fontWeight:900,fontSize:"1.1em",lineHeight:1}}>A</span><span style={{color:"#4ade80",fontWeight:900,display:"inline-block",transform:"rotate(-22deg)",transformOrigin:"bottom center",marginLeft:"0.05em",lineHeight:1,verticalAlign:"0.03em"}}>i</span>
    </span>
  );
}
