                    ...
                    {filteredItems.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {filteredItems.map((it) => {
                          ...
                          return (
                            <div key={it.id} className="rounded-lg px-3 py-2" style={{background: urgent ? "linear-gradient(160deg,#3b0a0a,#4c1313)" : soon ? "#0a0a0a" : "linear-gradient(160deg,#064e3b,#065f46)", border: urgent ? "1px solid rgba(239,68,68,0.4)" : soon ? "1px solid rgba(234,179,8,0.4)" : "1px solid rgba(255,255,255,0.15)"}}>
